...
import (
	...
	"github.com/sercanakmaz/go-boilerplate-v3/pkg/elastic"
...
func Init(cmd *cobra.Command, args []string) error {
	...
	client := elastic.NewElasticClient([]string{cfg.ElasticSearch.Host + ":" + cfg.ElasticSearch.Port})

	consumer := NewElasticProductConsumer(messageBus, logger, client)
	consumer.Construct()
